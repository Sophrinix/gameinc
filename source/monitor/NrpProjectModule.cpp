...
void CNrpProjectModule::Update( CNrpUser& refUser, const NrpTime& time )
{
	...
	if( (int)_self[ CODEPASSED ] < (int)_self[ CODEVOLUME] )
	{
		...
		//количество кода не должно быть больше задуманного
		...
		//ln( 270 / 100 ) = 1 - когда настроние нормальное -> количество ошибок стандартное
		//настроение падает количество ошибок растет
		...
		//количество ошибок не должно быть отрицательным
