...
void CNullDriver::draw2DImage( const video::ITexture* texture, const core::position2d<s32>& pos, const core::rect<s32>& sourceRect, 
                               const f32 rotation, 
                               const bool filtering, 
                               const core::vector2df scale, SColor color, bool useAlphaChannelOfTexture )
{
    draw2DImage( texture, pos, sourceRect, NULL, color, useAlphaChannelOfTexture );
}
